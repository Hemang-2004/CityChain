  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.infoContainer}>
        ...
        {user.previousRides.map((ride, index) => (
          <View key={ride.id} style={styles.rideContainer}>
            <Text style={styles.rideText}>
              From {ride.pickupLoc} to {ride.dropoffLoc} on {new Date(ride.completeAt).toLocaleDateString()}
            </Text>
            {index < user.previousRides.length - 1 && <View style={styles.rideDivider} />}
          </View>
        ))}
        <View style={styles.divider} />
        <View style={styles.infoRow}>
