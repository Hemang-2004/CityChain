    ...
    <div className={`bg-primary text-white`}>
      <div className={`flex flex-col grid justify-items-center pt-14`}>
        ...
        <p className="text-white pt-5 text-[20px] text-center">
          Citychain is a project made to transition from standard smart hardware to <br></br>open source
          Blockchain hardware
        </p>
        <div className="mt-5">
          ...
          <a href='https://github.com/Hemang-2004/CityChain'>
        ...
        <div className={`mt-5`}>
          <small className="text-white font-weight-bold mb-0 mr-2">
            *Proudly Developed by <a href='https://www.linkedin.com/in/hemang-seth-416a42256/'>Gaymang</a>, <a href='https://www.linkedin.com/in/tanish-pathania-82b67526b/'>Tanish</a>, <a href='https://www.linkedin.com/in/aryaman-pathak/'>Aryaman</a> and <a href='https://www.linkedin.com/in/siddharth-vikram-523835219/'>Siddharth</a>
          </small>
        </div>
        ...
        <div className='flex flex-row w-full justify-between pt-20 pb-20'>
          <div className='flex flex-col ml-10 feature-card p-4 items-center rounded-lg'>
            ...
            <p>
              CityChain handles the infamous problem of <br></br> 
          ...
          <div className='flex flex-col mr-10 p-4 feature-card items-center rounded-lg'>
            ...
            <p>
              CityChain can be configured for development <br></br>
              purposes. Developers looking for support <br></br>
              on CityChain can go through the Github repo <br></br>
